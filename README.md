...
**一个基于 Vue 3 + Vite + Vanilla CSS 构建的极简 AI 微短剧剧本与爆点策划专家微应用，具备深色玻璃拟态自适应交互与微信端 H5 体验**
...
1. **故事核心梗概与黄金前3秒卡点**：精炼剧本核心冲突，设计开局前3秒瞬间抓眼的生死悬念或极致打脸钩子，提升完播留存。
2. **主要角色人设张力与对立关系**：打造具备高反差感的男女主人设，明确正邪阵营与极具戏剧张力的对立关系。
3. **分集剧情大纲与爆点反转节奏**：按集数规划剧情推移，标出每集末尾的卡点留存钩子（Cliffhanger）与高潮反转点。
4. **拍摄分镜提示与台词金句**：选取核心爆点镜头给出景别、运镜、音效提示及情绪饱满的高传播度爆款金句台词。

## 5 大 AI 评估指标

1. **戏剧冲突强度 (conflictIntensity)**：评估故事设定、正邪对抗及核心矛盾的剧烈程度与吸引力。
2. **黄金前3秒节奏 (goldenPacing)**：评估开局钩子、悬念抛出速度与前3秒抓住用户的完播留存潜质。
3. **高潮反转爆发力 (climaxReversal)**：评估剧情节点反转的意外性、爽感打脸度与情绪宣泄冲击力。
4. **人设对立张力 (characterTension)**：评估主角与反派反差感、性格碰撞及情感羁绊的戏剧拉扯深度。
5. **拍摄分镜可行性 (shootingFeasibility)**：评估分镜运镜描述、景别调度与拍摄落地的可操作性与成本控制。
...
node bin/cli.js set ai-duanju prompt "你是一位爆款微短剧编剧总监..."
